"""
    ...
    Build neural net using sklearn tools insted of keras.
...
result = clf.predict([[1., 2., 3., 4.,5., 6., 7., 8., 9.]])
print("\n\nresult = {}\n\n".format(result[:]))
print("got to past the sklearn spot")
